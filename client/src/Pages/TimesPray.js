      ...
      <div className="content">
            ...
            <div className="tracking-in-expand-fwd-top">
              <h1
                style={{
                  ...
                  color: "#fff",
                  textShadow:
                    "4px 4px 8px rgba(0, 0, 0, 0.7), 0 0 3px rgba(0, 0, 0, 0.9), 0 0 3px rgba(0, 0, 0, 0.9), 0 0 3px rgba(0, 0, 0, 0.9), 0 0 3px rgba(0, 0, 0, 0.9)",
                  textTransform: "uppercase",
                  letterSpacing: "2px",
                  fontFamily: "shmulikclm-webfont",
                  padding: "10px",
                }}
              >
                זמני תפילות
        ...
        >
          <Table
            striped
            bordered
            className={isEditing ? "table-background" : "table-content"}
            style={{ width: "100%" }}
          >
            <colgroup>
              <col style={{ width: "50%" }} />
            ...
            <thead>
              <tr>
                <th style={{ textAlign: "center" }} className={"table-content"}>
                  זמן
                </th>
                <th style={{ textAlign: "center" }} className={"table-content"}>
                  יום
